...
from src import dynamic_planes_conv_onet
import pdb

## keys onet and dynamic_planes_convolutional_onet give the same model due to legacy configurations
method_dict = {
    'dynamic_planes_conv_onet': dynamic_planes_conv_onet
}
